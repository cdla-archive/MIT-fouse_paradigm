...
# -*- coding: utf-8 -*-
"""
This experiment was created using PsychoPy2 Experiment Builder (v1.76.00), Tue Jul 16 01:31:43 2013
...
face_image = visual.PatchStim(win=win, name='face_image',
    ...
    color=[1,1,1], colorSpace=u'rgb', opacity=.5,
    texRes=128, interpolate=True, depth=0.0)
...
while continueRoutine and routineTimer.getTime() > 0:
    ...
    elif image_4.status == STARTED and t >= (0.0 + 1.0):
...
trials = data.TrialHandler(nReps=5, method=u'sequential', 
    ...
    trialList=data.importConditions(u'conditions/fouse_conditions.xlsx'),
...
for thisTrial in trials:
    ...
    face_loop = data.TrialHandler(nReps=1, method=u'random', 
        extraInfo=expInfo, originPath=None,
        trialList=data.importConditions(u'conditions/fouse_stimuli_facelist.xlsx'),
    ...
    for thisFace_loop in face_loop:
        ...
        scene_loop = data.TrialHandler(nReps=1, method=u'random', 
            extraInfo=expInfo, originPath=None,
            trialList=data.importConditions(u'conditions/fouse_stimuli_scenelist.xlsx'),
            seed=None, name='scene_loop')
        ...
        for thisScene_loop in scene_loop:
            ...
            while continueRoutine and routineTimer.getTime() > 0:
                ...
                elif face_image.status == STARTED and t >= (0.0 + 1):
                ...
                elif scene_image.status == STARTED and t >= (0.0 + 1.0):
    ...
    while continueRoutine and routineTimer.getTime() > 0:
        ...
        elif image_2.status == STARTED and t >= (0.0 + 1):
    ...
    while continueRoutine and routineTimer.getTime() > 0:
        ...
        elif image_3.status == STARTED and t >= (0.0 + 1):
